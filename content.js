const gymData = {
    "location1": {
        ...
        description: {
            point1: "This is the first paragraph about the Town Square. It focuses on the community atmosphere.",
            point2: "This is the second paragraph. Here, I observed how the outdoor equipment handles weather wear.",
            point3: "This is the third paragraph. I concluded that urban gyms are the future of accessible fitness."
        }
    },
    "location2": {
        label: "Location 2",
        ...
        description: {
            point1: "Industrial vibes only. This place is huge.",
            point2: "The equipment is older but very well-maintained.",
            point3 : "It will be pretty cool if this adf"
        }
    },
    "location3": {
        label: "Location 3",
        ...
        description: {
            ...
            point2: "The equipment is older but very well-maintained.",
            point3 : "It will be pretty cool if this adf",
            point4 : "It will be pretty cool if this adf",
            point5 : "It will be pretty cool if this adf"
        }
    }
};
